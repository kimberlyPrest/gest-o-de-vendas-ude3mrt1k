                    ...
                    return (
                        <div key={item.id} className="space-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <span
                                    className={`font-semibold text-[15px] tracking-tight ${isBest ? 'text-[#1D1D1F]' :
            ...
            <div className="px-8 pt-8 pb-6 border-b border-[#E5E5E7]">
                <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <CardTitle className="text-xl font-semibold tracking-tight text-[#1D1D1F]">Comparativo de Hosts</CardTitle>
