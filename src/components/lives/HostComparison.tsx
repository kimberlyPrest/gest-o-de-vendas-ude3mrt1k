...
export const HostComparison: React.FC<HostComparisonProps> = ({
  data,
  presenters,
}) => {
  ...
  return (
    <Card className="bg-white/80 backdrop-blur-md border border-[#E5E5E7] rounded-[20px] shadow-sm mb-8 overflow-hidden">
      {/* Header */}
      <div className="px-8 pt-8 pb-6 border-b border-[#E5E5E7]">
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <CardTitle className="text-xl font-semibold tracking-tight text-[#1D1D1F]">
                Comparativo de Hosts
              </CardTitle>
              <p className="text-sm text-[#86868B] mt-0.5">
                Análise lado a lado dos top performers
              </p>
            </div>
          </div>
        ...
        >
          {hostStats.map((host) => (
            <div key={host.id} className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-[#1D1D1F] truncate max-w-[120px]">
                  {host.name}
                </p>
